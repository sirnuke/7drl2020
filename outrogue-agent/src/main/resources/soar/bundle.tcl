# Glide vDEVELOPMENT
# Generated on 2020-03-01T20:36:49.950315700Z
#
# Arguments: -o bundle.tcl --continuous definitions.glide
#
# Autogenerated code, do not modify

namespace eval Creatures {
    # Element INPUT Creatures /C:/Users/sirnuke/Documents/git/outrogue/outrogue-agent/src/main/resources/soar/definitions.glide@1:0 :  1 members 0 matches
    variable identifier creatures
    variable type Creatures
    array set members "
        creature { support any tag false type Creature tcl Creature optional false const true multiple true }
    "

    namespace export bind
    proc bind { args } {
        upvar binding binding
        ::Glide::_bind "Creatures" $args

    }
}
namespace eval Creature {
    # Element INPUT Creature /C:/Users/sirnuke/Documents/git/outrogue/outrogue-agent/src/main/resources/soar/definitions.glide@5:0 :  2 members 0 matches
    variable identifier creature
    variable type Creature
    array set members "
        id { support any tag false type Int tcl Int optional false const true multiple false }
        self { support any tag false type Boolean tcl Boolean optional true const true multiple false }
    "

    namespace export bind
    proc bind { args } {
        upvar binding binding
        ::Glide::_bind "Creature" $args

    }
}
namespace eval Action {
    # Element OUTPUT Action /C:/Users/sirnuke/Documents/git/outrogue/outrogue-agent/src/main/resources/soar/definitions.glide@10:0 :  1 members 0 matches
    ::NGS_DeclareType Action {}
    variable identifier action
    variable type Action
    array set members "
        type { support any tag false type String tcl String optional false const true multiple false }
    "

    namespace export bind
    proc bind { args } {
        upvar binding binding
        ::Glide::_bind "Action" $args

    }
    namespace export modify
    proc modify { args } {
        ::Glide::_modify "Action" $args

    }
    namespace export construct
    proc construct { args } {
        ::Glide::_construct "Action" $::NGS_REPLACE_IF_EXISTS $args

    }
    namespace export construct-set
    proc construct-set { args } {
        ::Glide::_construct "Action" $::NGS_ADD_TO_SET $args

    }
    namespace export deploy
    proc deploy { args } {
        ::Glide::_deploy "Action" $args
